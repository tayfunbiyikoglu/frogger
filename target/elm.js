...
var _user$project$Frogger$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Frogger$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Hello Frogger')
			]));
};
var _user$project$Frogger$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Frogger$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: 0, _1: _elm_lang$core$Platform_Cmd$none},
			update: _user$project$Frogger$update,
			view: _user$project$Frogger$view,
			subscriptions: _user$project$Frogger$subscriptions
		})
};
var _user$project$Frogger$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Frogger'] = Elm['Frogger'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Frogger'], 'Frogger', typeof _user$project$Frogger$main === 'undefined' ? null : _user$project$Frogger$main);
